...
export function runMigrations(sqlite: Database.Database): void {
  ...
  if (!schedulerCols.some((c) => c.name === "total_in_sats")) {
    sqlite.exec(`ALTER TABLE scheduler_state ADD COLUMN total_in_sats INTEGER NOT NULL DEFAULT 0`);
    sqlite.exec(`
  ...
  if (!schedulerCols.some((c) => c.name === "total_out_sats")) {
    sqlite.exec(`ALTER TABLE scheduler_state ADD COLUMN total_out_sats INTEGER NOT NULL DEFAULT 0`);
    sqlite.exec(`
  ...
  if (!schedulerCols.some((c) => c.name === "victim_count")) {
    sqlite.exec(`ALTER TABLE scheduler_state ADD COLUMN victim_count INTEGER NOT NULL DEFAULT 0`);
    sqlite.exec(`
  ...
  if (!schedulerCols.some((c) => c.name === "hacker_active_count")) {
    sqlite.exec(`ALTER TABLE scheduler_state ADD COLUMN hacker_active_count INTEGER NOT NULL DEFAULT 0`);
    sqlite.exec(`
  ...
  if (!schedulerCols.some((c) => c.name === "crawl_expanded_count")) {
    sqlite.exec(`ALTER TABLE scheduler_state ADD COLUMN crawl_expanded_count INTEGER NOT NULL DEFAULT 0`);
    sqlite.exec(`
  ...
  if (!schedulerCols.some((c) => c.name === "crawl_max_hop_reached")) {
    sqlite.exec(`ALTER TABLE scheduler_state ADD COLUMN crawl_max_hop_reached INTEGER NOT NULL DEFAULT 0`);
    sqlite.exec(`
