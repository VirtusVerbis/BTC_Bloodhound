...
export const schedulerState = sqliteTable("scheduler_state", {
  ...
  d1RowsReadOverhead: integer("d1_rows_read_overhead").notNull().default(0),
  d1RowsWrittenOverhead: integer("d1_rows_written_overhead").notNull().default(0),
  flaggedHackersCacheJson: text("flagged_hackers_cache_json"),
  ...
  activeExpandCount: integer("active_expand_count").notNull().default(0),
  activeBackfillCount: integer("active_backfill_count").notNull().default(0),
  activeAuditCount: integer("active_audit_count").notNull().default(0),
  activeProcessTxCount: integer("active_process_tx_count").notNull().default(0),
