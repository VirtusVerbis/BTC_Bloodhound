...
- **Expand caps:** `MAX_PENDING_EXPAND_PER_ADDRESS` (2) and `MAX_PENDING_EXPAND_GLOBAL` (40) limit pending+running expand jobs; blocked enqueue defers with `[job] defer reason=expand_cap`.
